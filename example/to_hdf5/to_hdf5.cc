                 ...
                 char *argv_first[], char *argv_last[])
{
    for (char **p = argv_first; p != argv_last; p++) {
        ...
        hi_tree->SetBranchAddress("track_quality",
                                      &track_quality[0]);
        hi_tree->SetBranchAddress("track_eta_emcal",
                                      &track_eta_emcal[0]);
        hi_tree->SetBranchAddress("track_phi_emcal",
                                      &track_phi_emcal[0]);
...
int main(int argc, char *argv[])
{
    ...
    UInt_t ntrack_max = find_ntrack_max(argv + 1, argv + argc - 1);
